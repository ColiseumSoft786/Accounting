...
<head>
    ...
    <meta name="author" content="Abuzar ">
    <title>Accounts - @yield('title')</title>
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,500i%7COpen+Sans:300,300i,400,400i,600,600i,700,700i" rel="stylesheet">
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('account/css/vendors.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('account/vendors/css/charts/jquery-jvectormap-2.0.3.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('account/vendors/css/charts/morris.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('account') }}/vendors/css/extensions/unslider.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('account') }}/vendors/css/weather-icons/climacons.min.css">
    <!-- END VENDOR CSS-->
    <!-- BEGIN STACK CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('account') }}/css/plugins/extensions/toastr.min.css">
    @yield('style')
    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href=""><img class="brand-logo" alt="" src="{{ asset('account') }}/images/logo/icon.PNG" style="width: 27px;height: 27px">
                        <h2 class="brand-text">Accounts</h2></a></li>
        ...
        <div class="navbar-container container center-layout">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                                ...
                                <ul class="drilldown-menu">
                                    <li class="menu-list">
                                        <ul>
                                            ...
                                            <li><a class="dropdown-item" href="color-palette-primary.html"><i class="ft-camera"></i> Color pallet system</a></li>
                    ...
                    <li class="nav-item nav-search"><a class="nav-link nav-link-search" href="#"><i class="ficon ft-search"></i></a>
                        <div class="search-input">
                            <input class="input" type="text" placeholder="Explore Accouts...">
                        </div>
                    </li>
                </ul>
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="avatar avatar-online"><img src="{{ asset('account') }}/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">{{ Auth::user()->name }}</span></a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="dropdown-item" href="{{ route('logout') }}"><i class="ft-power"></i>
                                Logout
                            </a>
...
<div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-light navbar-without-dd-arrow navbar-shadow menu-border" role="navigation" data-menu="menu-wrapper">
    ...
    <div class="navbar-container main-menu-content container center-layout" data-menu="menu-container">
        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item"><a class="nav-link" href="{{ route('home') }}"><i class="ft-home"></i><span>Dashboard</span></a>
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="ft-monitor"></i><span>Templates</span></a>
                <ul class="dropdown-menu">
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown">Vertical
                            <submenu class="name"></submenu></a>
                        <ul class="dropdown-menu">
                            <li data-menu=""><a class="dropdown-item" href="../vertical-modern-menu-template/index.html" data-toggle="dropdown">Modern Menu
                                    <submenu class="name"></submenu></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item" href="../vertical-menu-template/index.html" data-toggle="dropdown">Semi Light
                                    <submenu class="name"></submenu></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item" href="../vertical-menu-template-semi-dark/index.html" data-toggle="dropdown">Semi Dark
                                    <submenu class="name"></submenu></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item" href="../vertical-menu-template-nav-dark/index.html" data-toggle="dropdown">Nav Dark
                                    <submenu class="name"></submenu></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item" href="../vertical-menu-template-light/index.html" data-toggle="dropdown">Light
                                    <submenu class="name"></submenu></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item" href="../vertical-overlay-menu-template/index.html" data-toggle="dropdown">Overlay Menu
                                    <submenu class="name"></submenu></a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown">Horizontal
                            <submenu class="name"></submenu></a>
                        <ul class="dropdown-menu">
                            <li data-menu=""><a class="dropdown-item" href="index.html" data-toggle="dropdown">Classic
                                    <submenu class="name"></submenu></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item" href="../horizontal-menu-template-nav/index.html" data-toggle="dropdown">Nav Dark
                                    <submenu class="name"></submenu></a>
                            </li>
                        </ul>
                    </li>
...
<footer class="footer footer-static footer-light navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2 container center-layout"><span class="float-md-left d-block d-md-inline-block">Copyright  &copy; 2018 <a class="text-bold-800 grey darken-2" href="" target="_blank">Coliseum Soft </a>, All rights reserved. </span><span class="float-md-right d-block d-md-inline-block d-none d-lg-block">Developed by <a
                    href="">Abuzar Mughal</a></span></p>
</footer>
...
<script src="{{ asset('account') }}/vendors/js/extensions/jquery.knob.min.js" type="text/javascript"></script>
<script src="{{ asset('account') }}/js/scripts/extensions/knob.min.js" type="text/javascript"></script>
<script src="{{ asset('account') }}/vendors/js/charts/raphael-min.js" type="text/javascript"></script>
<script src="{{ asset('account') }}/vendors/js/charts/morris.min.js" type="text/javascript"></script>
<script src="{{ asset('account') }}/vendors/js/charts/jvector/jquery-jvectormap-2.0.3.min.js" type="text/javascript"></script>
<script src="{{ asset('account') }}/vendors/js/charts/jvector/jquery-jvectormap-world-mill.js" type="text/javascript"></script>
<script src="{{ asset('account') }}/data/jvector/visitor-data.js" type="text/javascript"></script>
<script src="{{ asset('account') }}/vendors/js/charts/chart.min.js" type="text/javascript"></script>
<script src="{{ asset('account') }}/vendors/js/charts/jquery.sparkline.min.js" type="text/javascript"></script>
<script src="{{ asset('account') }}/vendors/js/extensions/unslider-min.js" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="{{ asset('account') }}/css/core/colors/palette-climacon.css">
<link rel="stylesheet" type="text/css" href="{{ asset('account') }}/fonts/simple-line-icons/style.min.css">
<!-- END PAGE VENDOR JS-->
<script src="{{ asset('account') }}/vendors/js/extensions/toastr.min.js" type="text/javascript"></script>
<!-- BEGIN STACK JS-->
...
<script src="{{ asset('account') }}/js/scripts/pages/dashboard-analytics.min.js" type="text/javascript"></script>
@yield('script')
<script>
</script>
</body>
